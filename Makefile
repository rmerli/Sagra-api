...
migrate-up:
	...
	DB_USER=sagra DB_PASSWORD=sagra sql-migrate up -config=config/dbconfig.yml -env test

migrate-down:
	DB_USER=sagra DB_PASSWORD=sagra sql-migrate down -config=config/dbconfig.yml
	DB_USER=sagra DB_PASSWORD=sagra sql-migrate down -config=config/dbconfig.yml -env test
migrate-fresh:
	DB_USER=sagra DB_PASSWORD=sagra sql-migrate down -config=config/dbconfig.yml
	DB_USER=sagra DB_PASSWORD=sagra sql-migrate down -config=config/dbconfig.yml -env test
	DB_USER=sagra DB_PASSWORD=sagra sql-migrate up -config=config/dbconfig.yml
